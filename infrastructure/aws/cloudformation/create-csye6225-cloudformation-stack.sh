...
##Creating Stack
aws cloudformation create-stack --stack-name "$1" --template-body file://IAM-roles-policies-profile0.yml --parameters file://IAM-parameters.json --capabilities CAPABILITY_NAMED_IAM
aws cloudformation wait stack-create-complete --stack-name $1

echo "stack $1 is created"

sed -i "s/STACK_NAME/$2/" ec2-parameters.json
