...
##Creating Stack
aws cloudformation create-stack --stack-name "$1" --template-body file://create-lambda-function.yml --parameters file://parameters.json --capabilities CAPABILITY_NAMED_IAM
